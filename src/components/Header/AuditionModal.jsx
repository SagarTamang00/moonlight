    ...
    <div data-lenis-prevent="true" className="modal-overlay fixed inset-0 z-[100] bg-black/80 backdrop-blur-md hidden overflow-y-auto">
      <div className="min-h-full flex items-center justify-center p-4 py-12">
        <div className="modal-content w-full max-w-lg bg-moon-grey/20 border border-white/10 rounded-2xl p-6 sm:p-8 relative overflow-hidden">
          ...
          <h2 className="text-3xl sm:text-4xl font-cinematic text-white mb-2 pr-8">Collaboration</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6 relative z-10">
            ...
            <div>
              ...
              <textarea
                ...
                required
                className="w-full bg-white/5 border border-white/10 rounded-lg px-3 py-2 sm:px-4 sm:py-3 text-white text-sm sm:text-base focus:outline-none focus:border-white/40 transition-colors resize-none"
              />            </div>
