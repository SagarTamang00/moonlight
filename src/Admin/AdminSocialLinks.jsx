...
const PLATFORMS = [
    ...
    {
        name: "Dribbble",
        icon: "ti-brand-dribbble",
    },
    {
        name: "Behance",
        icon: "ti-brand-behance",
    },
];

// const ICON_MAP = {
//     instagram: "ti-brand-instagram",
//     "x / twitter": "ti-brand-twitter",
...
const AdminSocialLinks = () => {
    ...
    const activePlatform =
        platform.trim() || selected;

    const canSubmit =
        !!activePlatform && !!url.trim();
                    ...
                    {links.length === 0 && (
                        <div className="bg-white dark:bg-[#0b0b0b] border border-neutral-200 dark:border-neutral-800 rounded-2xl p-10 text-center">
                            ...
                            <p className="text-sm text-neutral-500 dark:text-neutral-400">
                                Add your social platforms above
                            </p>
                        </div>
                    )}
